...
class GameInfo(BaseModel):
    ...
    home_team_elo_start: Optional[StrictInt] = Field(default=..., alias="homeTeamEloStart")
    home_team_elo_end: Optional[StrictInt] = Field(default=..., alias="homeTeamEloEnd")
    ...
    away_team_elo_start: Optional[StrictInt] = Field(default=..., alias="awayTeamEloStart")
    away_team_elo_end: Optional[StrictInt] = Field(default=..., alias="awayTeamEloEnd")
    ...
    __properties = ["id", "sourceId", "seasonLabel", "season", "seasonType", "startDate", "startTimeTbd", "neutralSite", "conferenceGame", "gameType", "tournament", "gameNotes", "status", "attendance", "homeTeamId", "homeTeam", "homeConferenceId", "homeConference", "homeSeed", "homePoints", "homePeriodPoints", "homeWinner", "homeTeamEloStart", "homeTeamEloEnd", "awayTeamId", "awayTeam", "awayConferenceId", "awayConference", "awaySeed", "awayPoints", "awayPeriodPoints", "awayWinner", "awayTeamEloStart", "awayTeamEloEnd", "excitement", "venueId", "venue", "city", "state"]
    ...
    def to_dict(self):
        ...
        # set to None if home_team_elo_start (nullable) is None
        # and __fields_set__ contains the field
        if self.home_team_elo_start is None and "home_team_elo_start" in self.__fields_set__:
            _dict['homeTeamEloStart'] = None

        # set to None if home_team_elo_end (nullable) is None
        # and __fields_set__ contains the field
        if self.home_team_elo_end is None and "home_team_elo_end" in self.__fields_set__:
            _dict['homeTeamEloEnd'] = None
        ...
        # set to None if away_team_elo_start (nullable) is None
        # and __fields_set__ contains the field
        if self.away_team_elo_start is None and "away_team_elo_start" in self.__fields_set__:
            _dict['awayTeamEloStart'] = None

        # set to None if away_team_elo_end (nullable) is None
        # and __fields_set__ contains the field
        if self.away_team_elo_end is None and "away_team_elo_end" in self.__fields_set__:
            _dict['awayTeamEloEnd'] = None
    ...
    def from_dict(cls, obj: dict) -> GameInfo:
        ...
        _obj = GameInfo.parse_obj({
            ...
            "home_team_elo_start": obj.get("homeTeamEloStart"),
            "home_team_elo_end": obj.get("homeTeamEloEnd"),
            ...
            "away_team_elo_start": obj.get("awayTeamEloStart"),
            "away_team_elo_end": obj.get("awayTeamEloEnd"),
