...
class TransferOrigin(BaseModel):
    """
    TransferOrigin
    """
    conference: Optional[StrictStr] = Field(...)
    name: Optional[StrictStr] = Field(...)
    id: Optional[StrictInt] = Field(default=..., description="*")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferOrigin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferOrigin:
        """Create an instance of TransferOrigin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferOrigin.parse_obj(obj)

        _obj = TransferOrigin.parse_obj({
