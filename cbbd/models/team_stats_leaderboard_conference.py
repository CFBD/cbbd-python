...
class TeamStatsLeaderboardConference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamStatsLeaderboardConference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamStatsLeaderboardConference:
        """Create an instance of TeamStatsLeaderboardConference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamStatsLeaderboardConference.parse_obj(obj)

        _obj = TeamStatsLeaderboardConference.parse_obj({
            "id": obj.get("id"),
