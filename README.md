...
```sh
pip install cbbd@1.27.2
```
(you may need to run `pip` with root permission: `sudo pip install cbbd@1.27.2`)
...
*RecruitingApi* | [**get_portal_transfers**](docs/RecruitingApi.md#get_portal_transfers) | **GET** /recruiting/portal | 
...
*StatsApi* | [**get_team_leaderboard_stats**](docs/StatsApi.md#get_team_leaderboard_stats) | **GET** /stats/team/leaderboard | 
...
## Documentation For Models
 ...
 - [TeamLeaderboardAdjustedEfficiency](docs/TeamLeaderboardAdjustedEfficiency.md)
 - [TeamLeaderboardAdjustedEfficiencyRankings](docs/TeamLeaderboardAdjustedEfficiencyRankings.md)
 ...
 - [TeamStatsLeaderboardConference](docs/TeamStatsLeaderboardConference.md)
 - [TeamStatsLeaderboardRecord](docs/TeamStatsLeaderboardRecord.md)
 - [TeamStatsLeaderboardRecordSummary](docs/TeamStatsLeaderboardRecordSummary.md)
 - [TeamStatsLeaderboardShotProfile](docs/TeamStatsLeaderboardShotProfile.md)
 - [TeamStatsLeaderboardShotProfileAtRim](docs/TeamStatsLeaderboardShotProfileAtRim.md)
 - [TeamStatsLeaderboardShotProfileDistribution](docs/TeamStatsLeaderboardShotProfileDistribution.md)
 - [TeamStatsLeaderboardShotProfileDunk](docs/TeamStatsLeaderboardShotProfileDunk.md)
 - [TeamStatsLeaderboardShotProfileFreeThrows](docs/TeamStatsLeaderboardShotProfileFreeThrows.md)
 - [TeamStatsLeaderboardShotProfileTipIn](docs/TeamStatsLeaderboardShotProfileTipIn.md)
 - [TeamStatsLeaderboardShotProfileTwoPointJumper](docs/TeamStatsLeaderboardShotProfileTwoPointJumper.md)
 - [TeamStatsLeaderboardSummary](docs/TeamStatsLeaderboardSummary.md)
 - [TeamStatsLeaderboardUnitStats](docs/TeamStatsLeaderboardUnitStats.md)
 - [TeamStatsLeaderboardUnitStatsFieldGoals](docs/TeamStatsLeaderboardUnitStatsFieldGoals.md)
 - [TeamStatsLeaderboardUnitStatsFouls](docs/TeamStatsLeaderboardUnitStatsFouls.md)
 - [TeamStatsLeaderboardUnitStatsPoints](docs/TeamStatsLeaderboardUnitStatsPoints.md)
 - [TeamStatsLeaderboardUnitStatsRebounds](docs/TeamStatsLeaderboardUnitStatsRebounds.md)
 - [TeamStatsLeaderboardUnitStatsTurnovers](docs/TeamStatsLeaderboardUnitStatsTurnovers.md)
 - [Transfer](docs/Transfer.md)
 - [TransferEligibility](docs/TransferEligibility.md)
 - [TransferOrigin](docs/TransferOrigin.md)
